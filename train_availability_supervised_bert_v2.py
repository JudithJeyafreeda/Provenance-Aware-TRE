...
python train_availability_supervised_bert_v2.py \
  --data_dir synthetic_dataset --out_dir availability_supervised_bert_v2 \
  --epochs 10 --batch_size 8 --availability_threshold 0.5 \
  --save_dir availability_supervised_bert_v2/weights

2) Score new controls any time, with the same weights:
python train_availability_supervised_bert_v2.py \
  --data_dir synthetic_dataset --out_dir availability_supervised_bert_v2 \
  --load_dir availability_supervised_bert_v2/weights \
  --extra_controls silent_controls/silent_removal_controls.csv,silent_controls/silent_keep_controls.csv
"""
